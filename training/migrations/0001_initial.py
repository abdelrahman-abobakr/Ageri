    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_name', models.CharField(default='', help_text='Name of the course', max_length=200)),
                ...
                ('training_hours', models.PositiveIntegerField(default=0, help_text='Total training hours for the course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('first_name', models.CharField(blank=True, help_text='First name for guest enrollment', max_length=100)),
                ('last_name', models.CharField(blank=True, help_text='Last name for guest enrollment', max_length=100)),
                ('email', models.EmailField(blank=True, help_text='Email for guest enrollment', max_length=254)),
                ('phone', models.CharField(blank=True, help_text='Phone number for guest enrollment', max_length=20)),
                ('organization', models.CharField(blank=True, help_text='Organization/Company for guest enrollment', max_length=200)),
                ('job_title', models.CharField(blank=True, help_text='Job title for guest enrollment', max_length=100)),
                ('enrollment_token', models.UUIDField(default=uuid.uuid4, help_text='Unique token for guest enrollment access', unique=True)),
                ...
                ('payment_method', models.CharField(blank=True, choices=[('cash', 'Cash'), ('bank_transfer', 'Bank Transfer'), ('credit_card', 'Credit Card'), ('mobile_payment', 'Mobile Payment'), ('check', 'Check'), ('other', 'Other')], help_text='Method used for payment', max_length=20)),
                ('payment_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Amount paid or to be paid', max_digits=10)),
                ...
                ('student', models.ForeignKey(blank=True, help_text='Registered user (null for guest enrollments)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='course_enrollments', to=settings.AUTH_USER_MODEL)),
            ],
            options={
