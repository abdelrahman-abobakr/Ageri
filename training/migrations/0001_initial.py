# Generated by Django 4.2.7 on 2025-07-02 09:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "prerequisites",
                    models.TextField(
                        blank=True, help_text="Course prerequisites and requirements"
                    ),
                ),
                (
                    "materials_provided",
                    models.TextField(
                        blank=True, help_text="Materials and resources provided"
                    ),
                ),
                (
                    "featured_image",
                    models.ImageField(
                        blank=True, null=True, upload_to="training/courses/"
                    ),
                ),
                (
                    "syllabus",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True, help_text="Who can access this service"
                    ),
                ),
                (
                    "required_documents",
                ...
                (
                    "featured_image",
                    models.ImageField(
                        blank=True, null=True, upload_to="training/public_services/"
                    ),
                ),
                (
                    "service_brochure",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "skills_requirements",
                    models.TextField(
                        blank=True, help_text="Required skills and knowledge"
                    ),
                ),
                (
                    "learning_objectives",
                    models.TextField(help_text="What trainees will learn and achieve"),
                ),
                (
                    "project_description",
                    models.TextField(
                ...
                (
                    "featured_image",
                    models.ImageField(
                        blank=True, null=True, upload_to="training/summer_programs/"
                    ),
                ),
                (
                    "program_brochure",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service_notes",
                    models.TextField(
                        blank=True, help_text="Internal notes about service delivery"
                    ),
                ),
                (
                    "results_summary",
                    models.TextField(
                        blank=True, help_text="Summary of service results"
                    ),
                ),
                (
                    "client_feedback",
                    models.TextField(
                        blank=True, help_text="Client feedback about the service"
                    ),
                ),
                (
                    "satisfaction_rating",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Additional notes about the enrollment"
                    ),
                ),
                (
                    "course",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "motivation_letter",
                    models.TextField(help_text="Why do you want to join this program?"),
                ),
                (
                    "relevant_experience",
                    models.TextField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="training_su_status_75690f_idx",
                    ),
                    models.Index(
                        fields=["program", "status"],
                        name="training_su_program_19cb08_idx",
                    ),
                ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["status", "start_date"], name="training_su_status_b51dc6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="summertraining",
            index=models.Index(
                ...
                name="training_su_is_feat_35581c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="summertraining",
            index=models.Index(
                fields=["application_deadline"], name="training_su_applica_c92ceb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="publicservicerequest",
            index=models.Index(
                fields=["status", "request_date"], name="training_pu_status_e4082f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="publicservicerequest",
            index=models.Index(
                fields=["service", "status"], name="training_pu_service_5f17ee_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="publicservicerequest",
            index=models.Index(
                fields=["urgency_level"], name="training_pu_urgency_e5555c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="publicservice",
            index=models.Index(
                fields=["status", "service_category"],
                name="training_pu_status_ab5cc6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="publicservice",
            index=models.Index(
                fields=["is_featured", "is_public"],
                name="training_pu_is_feat_829490_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="publicservice",
            index=models.Index(
                fields=["is_ongoing"], name="training_pu_is_ongo_232a1c_idx"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="training_co_status_645d11_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="courseenrollment",
            index=models.Index(
                fields=["payment_status"], name="training_co_payment_4bd6d5_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="course",
            index=models.Index(
                fields=["status", "start_date"], name="training_co_status_67cc0f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="course",
            index=models.Index(
                fields=["training_type", "difficulty_level"],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["is_featured", "is_public"],
                name="training_co_is_feat_58bf60_idx",
            ),
        ),
    ]
